...
#include "../bitss/move.h"				// for __addressof
#include "../bitss/stl_iterator_base_types.h"	// for iterator_traits,
						// categories and _Iter_base
#include "../bitss/cpp_type_traits.h"		// for __is_integer

#include "../bitss/stl_pair.h"			// for pair
