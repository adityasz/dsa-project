...
#include "../bitss/functexcept.h" // For __throw_bad_alloc().
#include "../bitss/stl_function.h" // For greater_equal, and less_equal.
#include "../new" // For operator new.
#include "../debugg/debug.h" // _GLIBCXX_DEBUG_ASSERT
