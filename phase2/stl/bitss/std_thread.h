...
#include "../bitss/functional_hash.h" // std::hash
#include "../bitss/invoke.h"	// std::__invoke
#include "../bitss/refwrap.h"       // not required, but helpful to users
#include "../bitss/unique_ptr.h"	// std::unique_ptr

#ifdef _GLIBCXX_HAS_GTHREADS
#include "../bitss/gthr.h"
#else
#include "../errno.h"
