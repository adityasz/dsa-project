...
#include "../bitss/functexcept.h"		// __throw_bad_array_new_length
#include "../bitss/uses_allocator.h"	// allocator_arg_t, __use_alloc
#include "../bitss/uses_allocator_args.h"	// uninitialized_construct_using_alloc
#include "../extt/numeric_traits.h"		// __int_traits
#include "../debugg/assertions.h"

#if ! __cpp_lib_make_obj_using_allocator
#include "../bitss/utility.h"		// index_sequence
