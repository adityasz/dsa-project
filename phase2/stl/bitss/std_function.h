...
#include "../bitss/invoke.h"      // __invoke_r
#include "../bitss/refwrap.h"     // ref wrapper, _Maybe_unary_or_binary_function
#include "../bitss/functexcept.h" // __throw_bad_function_call
