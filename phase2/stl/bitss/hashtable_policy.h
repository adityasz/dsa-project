...
#include "../bitss/functional_hash.h" // for __is_fast_hash
#include "../bitss/stl_algobase.h"	// for std::min, std::is_permutation.
#include "../bitss/stl_pair.h"	// for std::pair
#include "../extt/aligned_buffer.h"	// for __gnu_cxx::__aligned_buffer
#include "../extt/alloc_traits.h"	// for std::__alloc_rebind
#include "../extt/numeric_traits.h"	// for __gnu_cxx::__int_traits
